...
## What you are given
The parent passes: a one-line context ("we're designing/building X"), the exact files/paths to review, and any specific worry areas. You have no access to the parent's conversation — work only from the files and the codebase. Read them yourself.
